                        ...
                        <div class="dt-responsive table-responsive">
                            <table  id="" class="table table-xs table-info nowrap table" style="width : 100% ,border:none;">
                               ...
                               <table  class="table-xs" style="width: auto;margin-right: 0px;margin-left: auto;" >
                                        <tr>
                                        <TH >Taxes</TH>
                                        <td style="text-align:right" class="f-16 f-w-100">4500</td>
                                        </tr>
                                        <tr>
                                        <th>Total</th>
                                        <td style="text-align:right" class="f-16 f-w-100">896235.5</td>
                                        </tr>
                                        <tr>
                                        <th>Payments</th>
                                        <td style="color:green;text-align:right" class="f-16 f-w-300">500000</td>
                                        </tr>
                                       <tr>
                                       <th>Payments Due</th>
                                        <td style="color:red;text-align:right" class="f-16 f-w-300">300000</td>
                                       </tr>
