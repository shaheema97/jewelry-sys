...
$g_rate=new rate();
$result=$g_rate->get_today_rate();

$error_msg="";
if(isset($_POST['user_email'])){
    $login_user=new login();
    $res=$login_user->ad_login($_POST['user_email'],$_POST['user_pwd']);
    ...
    if($res==true){
        ...
        if($_SESSION["user"]["usertype"]==2){
            ...
            if($result==null)
            {header("location:../goldrate/rate_form.php");}
            else{
        ...
        elseif($_SESSION["user"]["usertype"]==3){
                ...
                if($result==null)
                {header("location:../goldrate/error.php");}
                else{
                    header("location:../dashboard/craftsman_dashboard.php");
                }
        ...
        header("location:../pawn/pawnfrm2.php");}
    }
    else{
                    ...
                    <!-- Authentication card start -->
                        ...
                        <form class="md-float-material form-material" method="POST" >
                            <div class="text-center">
                                <img src="..\files\NSlogo1.png" alt="logo.png">
                            </div>
                            <div class="auth-box card">
                                <div class="card-block">
                                    ...
                                    <div class="form-group form-primary">
                                        <input type="password" name="user_pwd" class="form-control" required="" placeholder="Password">
                                        <span class="form-bar"></span>
                                    </div>
